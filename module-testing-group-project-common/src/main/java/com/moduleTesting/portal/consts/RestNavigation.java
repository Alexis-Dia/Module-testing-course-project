...
public interface RestNavigation {
   ...
   String PATH_TASK_CHANGE_TASK_TO_VALIDATED_STATUS = "/task/changeTaskStatusToValidated";
   String PATH_TASK_CHANGE_TASK_BY_TASK_ID = "/task/changeTaskStatusByTaskId";
   String PATH_TASK_CHANGE_TASK_TO_REJECTED_OR_FINISHED_STATUS = "/task/changeTaskStatusToFinish";
   ...
   String PATH_REPORT_ALL = "/report/all";
   String PATH_CAR_ALL_FREE = "/car/allFree";
   String PATH_CAR_ALL = "/car/all";
   String PATH_CAR_ADD_NEW = "/car/addNew";
